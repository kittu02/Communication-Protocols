...
module i2c_master_altera(
    input clk_200kHz,               // generated by clkgen_200kHz (50MHz -> 200kHz)
    ...
    output SCL                      // i2c standard interface signal - 10KHZ (derived inside)
    );
    ...
    // Signal Declarations               
    parameter [7:0] sensor_address_plus_read = 8'b1001_0111; // 0x97 (7'h4B <<1 + R)
    ...
    // State Declarations - need 28 states (copied from original)
    ...
    assign SDA_dir = (state_reg == POWER_UP || state_reg == START || state_reg == SEND_ADDR6 || state_reg == SEND_ADDR5 ||
                      ...
                      state_reg == SEND_ADDR0 || state_reg == SEND_RW || state_reg == SEND_ACK || state_reg == NACK) ? 1'b1 : 1'b0;
